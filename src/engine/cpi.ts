...
// US CPI-U annual averages (BLS, 1913-2024); 2025-2026 are projections at recent
// trend, refreshed with releases. Bundled like the currency fallback table.
const CPI: Record<number, number> = {
  ...
  2016: 240.007, 2017: 245.12, 2018: 251.107, 2019: 255.657, 2020: 258.811, 2021: 270.97,
  2022: 292.655, 2023: 304.702, 2024: 313.689, 2025: 322.1, 2026: 330.0,
};
...
export function cpiFor(year: number): Decimal | null {
  const v = CPI[year];
  return v === undefined ? null : new Decimal(v);
}

export const cpiYearRange = { min: MIN_YEAR, max: MAX_YEAR };
